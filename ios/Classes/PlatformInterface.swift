...
public class PlatformInterface: NSObject, LibboxPlatformInterfaceProtocol, LibboxCommandServerHandlerProtocol {
    public func readWIFIState() -> LibboxWIFIState? {
        nil
    }

    private let tunnel: SboxPacketTunnelProvider
    private var networkSettings: NEPacketTunnelNetworkSettings?

    init(_ tunnel: SboxPacketTunnelProvider) {
        self.tunnel = tunnel
    }
